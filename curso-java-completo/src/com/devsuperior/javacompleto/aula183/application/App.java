...
import com.devsuperior.javacompleto.aula183.entities.Client;
...
public class App {
	public static void main(String[] args) {
		...
		System.out.println(string3 == string4); // false: referencias de memoria diferentes para nao-literais 
