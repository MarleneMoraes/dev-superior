package com.devsuperior.javacompleto.aula179.application;

import java.util.Scanner;

import com.devsuperior.javacompleto.aula179.services.PrintService;
import com.devsuperior.javacompleto.aula179.services.PrintServiceObject;

/**
 * 
 * @author Marlene 
 * SECAO 17: Generics, Set, Map 
 * AULA 179. Introducao aos Generics
 *         
 */
...
public class Program {
	...
	public static void main(String[] args) {
		...
		System.out.println("First: " + x); // ClassCastException - este programa possui um valor String como primeiro
											// tipo, que nao pode ser convertido
